    ...
    if request.method == 'POST':
        ...
        try:
            dbConn = pymongo.MongoClient(
                "mongodb://Jaga:12345@clusterjagadeesh-shard-00-00.f6iyx.mongodb.net:27017,clusterjagadeesh-shard-00-01.f6iyx.mongodb.net:27017,clusterjagadeesh-shard-00-02.f6iyx.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-f9oggj-shard-0&authSource=admin&retryWrites=true&w=majority")
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                nextbox = prod_html.find('div',{'class': 'col JOpGWq'})  # getting the class where all the reviews are present
            ...
            return 'Be Specific while entering a product'
            #return render_template('results.html')
    else:
        return render_template('index.html')
if __name__ == "__main__":
